...
const defaultStaticConfig: ClientConfig = {
  meta: {
    name: 'Vortex Flow & Plumbing',
    phone: '(800) 555-FLOW',
    phoneRaw: '+18005553569',
    emergencyPhone: '(800) 911-FLOW',
    emergencyPhoneRaw: '+18009113569',
    email: 'ops@vortexflow.com',
    address: {
      ...
      zipCodes: ['94301', '94302', '94303', '94304', '94306', '94025', '94040', '94043', '94085'],
    },
    licenseNumber: 'CA-CSLB #984210-C36',
    rating: 4.9,
    reviewCount: 412,
  ...
  theme: {
    primaryAccent: 'indigo', // Indigo represent precise liquid flows
  ...
  services: [
    {
      ...
      steps: [
        { title: 'Emergency Dispatch', desc: 'Our automated digital dispatch assigns the closest live tracking technician.' },
        { title: 'Source Stabilization', desc: 'Upon arrival, our plumber identifies and isolates the master intake values.' },
        { title: 'Surgical Repair', desc: 'Defective pipes, joints, or valves are cut out and replaced with surgical copper or PEX-a.' },
        { title: 'Post-stabilization Test', desc: 'System-wide pressure-gauge testing ensures absolutely zero secondary leaks.' }
      ],
      faqs: [
        { question: 'What is considered a plumbing emergency?', answer: 'Any active flood, burst pipe, complete loss of water, sewer backup into living spaces, or absence of functional toilets in a single-bathroom home.' },
        { question: 'Do you charge extra for holidays or weekends?', answer: 'We maintain flat emergency dispatch rates, with upfront pricing shown before any tool is lifted, regardless of the calendar day.' }
      ],
      subServices: ['Burst Pipe Repair', 'Emergency Main Shutoff', 'Water Extraction', 'Sump Pump Failure Resolution'],
    ...
    },
    {
      ...
      steps: [
        { title: 'Thermal Scanning', desc: 'We inspect walls and slabs with infrared cameras to map anomalous temperature fields.' },
        { title: 'Acoustic Mapping', desc: 'Micro-acoustic sensors track high-frequency vibrations caused by micro-fractured pipes.' },
        { title: 'Gas Infiltration', desc: 'Safe tracer gas is injected to detect ultra-fine structural pinholes if acoustic lines are obstructed.' },
        { title: 'Surgical Marking', desc: 'We flag the exact leak coordinates, presenting a fixed restoration proposal.' }
      ],
      faqs: [
        { question: 'How do I know if I have a hidden leak?', answer: 'Common warning signs include unexplained surges in your water utility bill, hot spots on your flooring, structural dampness, or a spinning water meter when all taps are off.' },
        { question: 'Does insurance cover leak detection?', answer: 'Most homeowners insurance policies cover the cost of locating slab and pipe leaks when performed by a licensed contractor.' }
      ],
      subServices: ['Slab Leak Profiling', 'Drywall Cavity Scans', 'Underground Line Tracking', 'Micro-Pressure Testing'],
    ...
    },
    {
      ...
      steps: [
        { title: 'Fiber-Optic Scope', desc: 'We run a high-definition flexible camera to diagnose the blockages structural makeup.' },
        { title: 'Hydro-Jet Calibrated Run', desc: 'A custom rotational head-piece is configured for the pipes size and material composition.' },
        { title: 'Scouring Process', desc: 'Water scours the pipe, breaking up grease deposits, calcified blockages, and tree roots.' },
        { title: 'Final Inspection', desc: 'A follow-up video scan verifies pristine, obstruction-free lines.' }
      ],
      faqs: [
        { question: 'Is hydro-jetting safe for old pipes?', answer: 'Yes, when calibrated properly. We conduct video inspections beforehand to evaluate structural integrity and adjust water pressure accordingly.' },
        { question: 'How often should drains be hydro-jetted?', answer: 'For standard residential homes, every 2-3 years prevents critical blockages. High-volume commercial kitchens benefit from quarterly service.' }
      ],
      subServices: ['Main Sewer Line Clearing', 'Kitchen Grease Descaling', 'Root Infiltration Cutting', 'HD Video Sewer Scans'],
    ...
    },
    {
      ...
      steps: [
        { title: 'Load Assessment', desc: 'We calculate peak water demand and flow requirements across all fixtures.' },
        { title: 'System Decommissioning', desc: 'Old leaking tanks are drained, disconnected, and recycled sustainably.' },
        { title: 'Manifold Installation', desc: 'We run high-volume gas lines or heavy-gauge electrical circuits to feed the heat exchangers.' },
        { title: 'Wall Mounting & Calibration', desc: 'The tankless module is mounted, plumbed with bypass valves, and calibrated for flow.' }
      ],
      faqs: [
        { question: 'What is the cost difference between tank and tankless?', answer: 'While tankless heaters have a higher upfront cost, their double-length lifespan, high energy savings, and available tax rebates yield a full return on investment within 4-5 years.' },
        { question: 'How much maintenance do tankless heaters require?', answer: 'An annual flushing is recommended to clear scale deposits and keep the heat exchangers operating at 99% thermal efficiency.' }
      ],
      subServices: ['Tankless Conversion', 'Traditional Water Heaters', 'Recirculating Pump Setup', 'Anode Rod Replacement'],
    ...
    },
    {
      ...
      steps: [
        { title: 'Sewer Inspection', desc: 'Digital scoping locates cracks, offset joints, or root intrusions.' },
        { title: 'Pipe Prep & Descaling', desc: 'Drains are hydro-jetted clean to allow structural epoxy bonding.' },
        { title: 'Epoxy Liner Insertion', desc: 'An epoxy-saturated felt tube is blown or pulled into the damaged pipeline.' },
        { title: 'Pneumatic Curing', desc: 'The liner is inflated pneumatically and cured, forming a seamless pipe.' }
      ],
      faqs: [
        { question: 'What is CIPP lining, and how long does it last?', answer: 'Cured-In-Place Pipe is an advanced resin sleeve that cures into a structural pipe inside your old lines. It is rated to last 50+ years.' },
        { question: 'Is trenchless always possible?', answer: 'Trenchless is viable for 90% of cases, provided the original pipe has not completely collapsed and blocked the insertion paths.' }
      ],
      subServices: ['CIPP Epoxy Pipe Lining', 'Pipe Bursting Replacement', 'Sewer Cleanout Installs', 'Camera Line Mapping'],
    ...
    },
    {
      ...
      steps: [
        { title: 'Facility Audit', desc: 'Our commercial engineer maps out water inlets, drains, grease traps, and interceptors.' },
        { title: 'Hydraulic Calculations', desc: 'Flow velocity, volume loads, and pressure drops are modeled mathematically.' },
        { title: 'Implementation Plan', desc: 'Phased, off-hours execution keeps business doors open during upgrades.' },
        { title: 'Compliance Submission', desc: 'All tests, specifications, and stamps are logged directly with municipal inspectors.' }
      ],
      faqs: [
        { question: 'Why is annual backflow testing required?', answer: 'Backflow assemblies prevent polluted water from back-siphoning into the public clean drinking supply. Local water districts mandate testing annually.' },
        { question: 'Do you offer preventative maintenance agreements?', answer: 'Yes, we provide custom contracts for commercial properties including quarterly grease trap audits, hydro-jetting, and booster checks.' }
      ],
      subServices: ['Certified Backflow Prevention', 'Grease Trap Interceptor Maintenance', 'Multi-Story Water Systems', 'Booster Pump Calibration'],
  ...
  pricing: {
    ...
    propertyMultipliers: [
      { label: 'Residential Condo/Appt', value: 'apartment', multiplier: 0.95 },
      { label: 'Single Family Residential', value: 'residential', multiplier: 1.0 },
      { label: 'Large Estate / Multi-Story Home', value: 'estate', multiplier: 1.15 },
      { label: 'Light Commercial Facility', value: 'commercial-light', multiplier: 1.3 },
      { label: 'Industrial / Corporate Campus', value: 'commercial-heavy', multiplier: 1.6 }
    ],
    urgencyFactors: [
      { label: 'Routine (Next 3-5 Business Days)', value: 'routine', multiplier: 1.0, fee: 0 },
      { label: 'Priority Dispatch (Within 24 Hours)', value: 'priority', multiplier: 1.1, fee: 49 },
      { label: 'Emergency Response (Immediate, Under 45 Mins)', value: 'emergency', multiplier: 1.25, fee: 149 }
    ],
    addOnOptions: [
      { label: 'Felt Filter & Pipe Guard Installation', value: 'filter', price: 95, desc: 'Adds mesh filters to structural points to trap waste particles.' },
      { label: 'HD Sewer Camera Recording Link', value: 'recording', price: 45, desc: 'Receives a downloadable high-definition file and analysis report.' },
      { label: 'Extended 3-Year Service Warranty', value: 'warranty', price: 120, desc: 'Increases standard coverage on labor and materials to 3 full years.' },
      { label: 'Eco-Flow Low Consumption Calibrator', value: 'ecoflow', price: 75, desc: 'Sets precision flow restrictors to cut water volume by 15-20%.' }
    ]
  },
  faqs: [
    {
  ...
  blog: [
    {
      ...
      tags: ['Slab Leaks', 'Diagnostics', 'Home Maintenance'],
      relatedSlugs: ['how-ultrasonic-leak-detection-saves-drywall'],
    ...
    },
    {
      ...
      tags: ['Leak Detection', 'Ultrasonic Technology', 'Surgical Plumb'],
      relatedSlugs: ['signs-slab-leak-foundation'],
  ...
  pageContent: {
    home: {
      ...
      metrics: [
        { label: 'Avg Dispatch Time', value: '38 Min', desc: 'Real-time GPS fleet tracking' },
        { label: 'Structural Projects', value: '4.8k+', desc: 'Executed to strict building codes' },
        { label: 'Customer Trust Rating', value: '4.9★', desc: 'Based on 400+ certified reviews' },
        { label: 'Active Service Radius', value: '25 Mi', desc: 'Deep regional coverage in Silicon Valley' }
      ]
    },
    about: {
      story: {
      ...
      values: [
        { title: 'Surgical Precision', desc: 'We prioritize non-invasive diagnostics. We scan, map, and pinpoint issues using infrared heat cameras and acoustics before we ever touch a hammer.', icon: 'Crosshair' },
        { title: 'Absolute Transparency', desc: 'We do not believe in hourly quotes or surprise bills. You receive flat, fixed pricing options in writing before we lift a single tool.', icon: 'Eye' },
        { title: 'Long-Term Durability', desc: 'We do not apply band-aids. We build for decades, utilizing heavy copper, seamless PEX-a, and epoxy linings backed by 50-year structural warranties.', icon: 'CheckCircle' }
      ],
      timeline: [
        { year: '2018', title: 'The Launch of Vortex Flow', desc: 'Founded in Palo Alto with two specialized diagnostic trucks focusing on non-invasive pipe scans.' },
        { year: '2020', title: 'Trenchless Expansion', desc: 'Introduced CIPP cured-in-place sewer liners, eliminating the need to tear up yards and driveways.' },
        { year: '2023', title: 'Commercial Contract Mastery', desc: 'Launched our dedicated commercial facility maintenance team, securing backflow certifications for 80+ companies.' },
        { year: '2026', title: 'Digital Estimate Launch', desc: 'Introduced our fully interactive digital pricing matrix, offering instant estimation options online.' }
      ]
    },
    careersPage: {
      ...
      benefits: [
        { title: 'Elite Fleet Vehicles', desc: 'Take-home late-model Mercedes-Benz Sprinter vans fully equipped with high-end power tools and diagnostic scanners.', icon: 'Truck' },
        { title: 'Continual Education', desc: '100% company-sponsored certifications including AWWA Backflow testing, CIPP lining mastery, and mechanical safety.', icon: 'GraduationCap' },
        { title: 'Uncompromising Safety', desc: 'Top-tier safety equipment, active harness monitors, and structured operations that respect your health and well-being.', icon: 'Heart' }
      ]
    }
  },
  aiAssistant: {
    ...
    knowledgeBase: [
      {
        keywords: ['leak', 'detection', 'locate', 'acoustic', 'scan', 'scanning', 'slab'],
      ...
      {
        keywords: ['price', 'cost', 'quote', 'estimate', 'how much', 'rates'],
      ...
      {
        keywords: ['emergency', 'flood', 'burst', 'pipe', 'rupture', 'urgent', 'now', 'night', '24/7'],
      ...
      {
        keywords: ['clog', 'drain', 'jetting', 'sewer', 'trenchless', 'lining', 'cipp', 'pipe', 'liner'],
      ...
      {
        keywords: ['hello', 'hi', 'hey', 'greetings', 'who are you', 'bot'],
      ...
      {
        keywords: ['warranty', 'guarantee', 'repair', 'years'],
